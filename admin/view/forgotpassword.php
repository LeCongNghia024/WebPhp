<form action="index.php?action=register&act=register_admin" method="post" style="border:1px solid #ccc">
  <div class="container">
    ...
    <p style="color: red;">Please fill in this form to update new password</p>
    <hr>

    <label for="email"><b>Your Admin Email</b></label>
    <input type="text" placeholder="Enter Name" name="email" required>
    
    <label for="email"><b>Old Password</b></label>
    <input type="text" placeholder="Enter Email" name="oldpass" required>

    
    <label for="email"><b>New Password</b></label>
    <input type="text" placeholder="Enter Address" name="newpass" required>

    <label for="psw-repeat"><b>Confirm New Password</b></label>
    <input type="password" placeholder="Confirm Password" name="new-psw-repeat" required>
    <div class="clearfix">
