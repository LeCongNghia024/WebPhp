<form action="index.php?action=login&act=updatepass" method="post" style="border:1px solid #ccc" class="form-pass">
  <div class="container">
    ...
    <input type="password" placeholder="Confirm Password" name="newpass-repeat" required>
    <div class="clearfix">
